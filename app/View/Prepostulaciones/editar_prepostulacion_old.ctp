...
<div class="contenedor_nuevo_anexo">
    ...
    <div id="fila-archivo-nuevo-anexo" class="row margen contenedor_anexo">
            ...
            <div class="span3" id="anexo">
                ...
                <input type="hidden" name="data[Archivos][anexo][anexo_id]" class="anexoId" value="nuevo" id="PrepostulacionAnexoId" rel="">
                <input type="hidden" name="data[Archivos][anexo][valor_anexo_value]" class="valorAnexoValue" value="1" id="PrepostulacionAnexoValue">
				<input type="hidden" name="data[Archivos][anexo][valor_anexo_none]" class="valor_anexo_none" value="1" id="valor_anexo_none">
            </div>
            ...
            <div class="span2">
                    <div id="info-licencia">
                        <div id="img-error-licencia" class="" align="left">
                            <img src="/rap/img/test-fail-icon.png" title="No hay archivo" alt="">Archivo invalido, por favor cambiar
                        </div>
                        <div id="img-check-licencia" class="hide" align="left">
                            <img src="/rap/img/test-pass-icon.png" title="Archivo Permitido" alt="">Archivo correcto (será evaluado)
                        </div>                                    
                    </div>
            </div>
            <div class="span1">
...
<div id="modalValidar" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-header" id="modal_header">
        ...
        <div class="modal-footer">
                ...
                <a data-dismiss="modal" aria-hidden="true" class="btn cerrar" href="#">Cerrar</a>			
        </div>
		...
		<div class="row">
			...
			<div class="span4">				
				<div class="alert alert-warning">
					...
					<ul>
						Válido sólo para los siguientes colegios en la especialidad de gastronomía: <br>
						   - Cardenal Juan Francisco Fresno <br>
						   - San Alberto Hurtado <br>
						   - Juan Luis Undurraga Aninat <br>
						   - Poliv. Cardenal Raúl Silva Henríquez <br>
						   -Part. Cardenal Carlos Oviedo Cavada <br>
						Estos postulantes deben presentar sólo la documentación obligatoria. <br>
                            ...
                            <div class="span3" id="anexo">
                                    ...
                                    if($archAnexos['ArchivoPrepostulacion']['valido'] == null){
                                        ...
                                        */
                                        ...
                                        echo $this->Form->input('anexo_id', array('type' => 'hidden', 'name' => 'data[Archivos][anexo'.$count.'][anexo_id]', 'class' => 'anexoId','value' => $archAnexos['ArchivoPrepostulacion']['id'],'rel' => $archAnexos['ArchivoPrepostulacion']['id']));
										...
										echo $this->Form->input('valor_anexo_none', array('type' => 'hidden', 'name' => 'data[Archivos][anexo'.$count.'][valor_anexo_none]', 'class' => 'valor_anexo_none','value' => $archAnexos['ArchivoPrepostulacion']['id']));
                                    ...
                                    <div id="info-licencia">
                                            ...
                                            if($archAnexos['ArchivoPrepostulacion']['valido'] == null){
                                                ...
                                                */
                                                ...
                                                echo "<div id='img-error-licencia' class='hide' align='left'>".$this->Html->Image('test-fail-icon.png', array('title' => ' No hay archivo o '))." Archivo invalido, por favor cambiar</div>";
                                            }
                                            else if($archAnexos['ArchivoPrepostulacion']['valido'] == '0'){
                                                echo "<div id='img-error-licencia' class='' align='left'>".$this->Html->Image('test-fail-icon.png', array('title' => ' No hay archivo o '))." Archivo invalido, por favor cambiar</div>";
                                                echo "<div id='img-check-licencia' class='hide' align='left'>".$this->Html->Image('test-pass-icon.png', array('title' => ' Archivo Permitido'))." Archivo correcto (será evaluado)</div>";
...
<script type="text/javascript">
	...
	function isImage(extension){
	    ...
	    switch(extension.toLowerCase()){
	        case 'jpg': case 'jpeg': case 'pdf': case 'doc': case 'docx':  case 'png':
	            return true;
	        break;
	        default:
	            return false;
...
<script>
	...
	$('#nuevoAnexo').click(function(){
			...
			clone.find('.anexo_id').val('nuevo');
            clone.find('.valorAnexoValue').attr('name','data[Archivos][anexo'+anexos+'][valor_anexo_value]');
			clone.find('.valorAnexoValue').attr('name','data[Archivos][anexo'+anexos+'][valor_anexo_value]'); //asdasdasd
			...
			var count = 0;
			$('.contenedor_anexo').each(function(i){
				
				$('.tipoArchivo_radio').each(function(){
			...
			if(count>0){
				...
				clone.find(".tipoArchivo_radio").each(function(){
	...
	$('#borrarAnexo').click(function() {
        ...
        $('.edit_file_cancel2').on('click',function(e){
            ...
            if($(this).parent('div').parent('div').find('#generic_file').css('display') == 'inline-block'){
		...
		$('.tipoArchivo_radio').change(function(){
			/*
			$('.tipoArchivo_radio').attr('rel',($(this).val()));
			...
			if($(this).val() == 'Convenio'){
				...
				$('.contenedor_anexo').each(function(i){
					...
					$(this).find('.tipoArchivo_radio').each(function(){
						
						if($(this).val() == 'Convenio' && $(this).is('checked') == true){
							$(this).prop('checked', false);
			...
			*/
			...
			if($(this).val() == 'Convenio'){
				...
				$('.contenedor_anexo').each(function(i){
					...
					if(i > 1){ //Mayor que uno, es porque hay un .contenedor_anexo oculto al principio del archivo que sirve para crear nuevos
						$(this).remove();
					}
					
				});
				
				$('.contenedor_anexo').find('.nombreAnexo').css('visibility','hidden');
				$('.contenedor_anexo').find('.archivoAnexo').css('visibility','hidden');
				
				$('.contenedor_anexo').find('.nombreAnexo').prop('required',false);
				$('.contenedor_anexo').find('.archivoAnexo').prop('required',false);
				
				$('#nuevoAnexo').hide();
				

				$('.contenedor_anexo').find('.tipoArchivo_radio').each(function(){
				...
				$('.contenedor_anexo').find('.tipoArchivo_radio').prop("disabled",false);
				...
				$('.contenedor_anexo').find('.nombreAnexo').prop('required',true);
				$('.contenedor_anexo').find('.archivoAnexo').prop('required',true);
