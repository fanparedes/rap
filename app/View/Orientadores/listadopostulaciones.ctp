...
<div class="row-fluid">
	...
	<br>
		<table class="table table-bordered table-hover">
			<thead>
				<tr>
					<th width="30"><a href="<?php echo $this->webroot.'administracion/administrativos/listadopostulaciones';?>">#</a><?php						if (!isset($this->params['named']['direction'])) {
...
<div class="row-fluid">
	...
	<br>
		<table class="table table-bordered table-hover">
			<thead>
				<tr>
					<th width="30"><a href="<?php echo $this->webroot.'administracion/administrativos/postulantes';?>">#</a><?php						if (!isset($this->params['named']['direction'])) {
								echo ' <i class="icon-caret-down flechita"></i>';
							}
							else {
								echo ' <i class="icon-caret-down flechita2"></i>';
					...
					<th><?php echo $this->Paginator->sort('estado', 'Estado');						
						...
						<th style="width:11%;"><?php echo $this->Paginator->sort('fecha', 'Modificada');						
						if ($orden == 'fecha'){
							if ($this->params['named']['direction'] == 'asc') {
								echo ' <i class="icon-caret-down flechita"></i>';
							}
