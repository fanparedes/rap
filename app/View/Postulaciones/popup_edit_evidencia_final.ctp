...
<script>
$(function(){
		$('#relacion').html('<?php echo htmlspecialchars($datos['relacion']) ;?>');
		});
...
<form action="<?php echo $this->Html->url(array('controller'=>'postulaciones','action'=>'edit_evidencia_finales')); ?>" method="POST" class="form-horizontal" id="FormFormularioAdjuntarDocumentos" enctype="multipart/form-data">
				  ...
				  <div class="panel panel-default" style="margin-left:15px;">
					...
					<div id="collapseOne" class="panel-collapse collapse">
					  <div class="panel-body" style="padding-right:15px; text-align: justify;">							
							<p>Paso 1: <strong>Selección de las evidencias</strong><br /><br />
...
Cada evidencia debe documentarse.</p>
							<p>Paso 2: <strong>Justificación de las evidencias</strong><br /><br />
...
<script type="text/javascript">
	...
	function isImage(extension){
	    switch(extension.toLowerCase()){
	        case 'jpg': case 'gif': case 'png': case 'jpeg': case 'pdf': case 'doc': case 'docx': case 'xls': case 'xlsx': case 'odt': case 'ods': case 'rar': case 'zip':
	            return true;
	        break;
	        default:
	            return false;
