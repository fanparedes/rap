...
<form action="<?php echo $this->Html->url(array('controller'=>'postulaciones','action'=>'evidencia',$codigo_postulacion,$cod_unidad_comp)); ?>" method="POST" class="form-horizontal" id="FormFormularioAdjuntarDocumentos" enctype="multipart/form-data">
...
<script type="text/javascript">
	...
	function isImage(extension){	   
	   switch(extension.toLowerCase()){
	         case 'jpg': case 'gif': case 'rar': case 'zip': case 'png': case 'jpeg': case 'pdf': case 'doc': case 'docx': case 'xls': case 'xlsx': case 'odt': case 'ods':
	            return true;
	        break;
	        default:
	            return false;
