	...
	<div class="span10 offset1">
		...
		<div class="row-fluid">
			<div class="span7">
				...
				<?php echo $this->Form->input('nombre_sede', array('placeholder' => 'Nombre de sede','required' =>'required','class' => 'controls capitalizar','pattern' => '[a-zA-Z0-9ñÑáéíóúÁÉÍÓÚüÜ]+', 'onkeyup' => 'patron(this)'));?>
				<br>
