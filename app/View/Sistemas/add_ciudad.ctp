	...
	<div class="span10 offset1">
		...
		<div class="row-fluid">
			<div class="span7">
				...
				<?php echo $this->Form->input('nombre', array('placeholder' => 'Nombre de ciudad','required' =>'required','class' => 'controls capitalizar', 'pattern' => '[a-zA-Z0-9ñÑáéíóúÁÉÍÓÚüÜ]+', 'onkeyup' => 'patron(this)', 'maxlength'=> '50'));?>
