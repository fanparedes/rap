	...
	<div class="span10 offset1">
		...
		<div class="row-fluid">
			<div class="span7">
				...
				<?php echo $this->Form->input('etapa', array('placeholder' => 'Etapa','required' =>'required','class' => 'controls capitalizar', 'pattern' => '[a-zA-Z0-9ñÑáéíóúÁÉÍÓÚüÜ]+', 'onkeyup' => 'patron(this)', 'maxlength'=> '50'));?>
				<?php echo $this->Form->input('etapa_id', array('label'=>array('class'=> 'label_id', 'text'=>'Id Etapa'), 'placeholder' => 'Nº de etapa','required' =>'required','class' => 'controls capitalizar', 'type' => 'number',  'pattern' => '[a-zA-Z0-9ñÑáéíóúÁÉÍÓÚüÜ]+', 'onkeyup' => 'patron(this)', 'maxlength'=> '3'));?>
