	...
	<div class="span10 offset1">
		...
		<div class="row-fluid">
			<div class="span7">
				...
				<br><?php echo $this->Form->hidden('codigo', array('value' => $this->data['MedioInformacion']['codigo']));?>
				<?php echo $this->Form->input('nombre', array('placeholder' => 'Nombre de Medios','required' =>'required','class' => 'controls capitalizar', 'onkeyup' => 'patron(this)','value' => $this->data['MedioInformacion']['nombre']));?>
					<br>
