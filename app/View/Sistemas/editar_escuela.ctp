	...
	<div class="span10 offset1">
		...
		<div class="row-fluid">
			<div class="span7">
				...
				<?php echo $this->Form->input('nombre', array('placeholder' => 'Nombre de la escuela','required' =>'required','class' => 'controls capitalizar','pattern' => '[a-zA-Z0-9ñÑáéíóúÁÉÍÓÚüÜ]+', 'onkeyup' => 'patron(this)', 'value' => $escuela['Escuela']['nombre']));?>
				<br>
						...
						<table class="table table-striped table-bordered">
							...
							<tbody>
								...
								<tr>
									<td>
									<?php 	
									if (in_array($carrera['Carrera']['codigo'], $carrerasEscuela)): 
										$disabled_check = '';
										if($carrera['Carrera']['utilizado'] == 1){
											$disabled_check = '';
										}
										else{
										...
										//echo var_dump($carrera['Carrera']);
									?>
										<?php  echo $this->Form->input('EscuelaCarrera.'.$carrera['Carrera']['codigo'].'', array('type' => 'checkbox','label' => false, 'value' => 1, 'checked' => true,$disabled_check))?>		</td>
									<?php else:
										...
										//echo var_dump($carrera['Carrera']);
										?>
										<?php echo $this->Form->input('EscuelaCarrera.'.$carrera['Carrera']['codigo'].'', array('type' => 'checkbox','label' => false, 'value' => 1, $disabled_check))?>	
									<?php endif; ?>
									</td>
