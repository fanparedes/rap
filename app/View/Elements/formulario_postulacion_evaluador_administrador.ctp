		  ...
		  <div class="accordion-group">
		    ...
		    <div id="collapseCinco" class="accordion-body collapse">
		      <div class="accordion-inner">
			   ...
			   <div class="row-fluid">
					<h5>Nombre: <span class="capitalizar"><?php echo($evidencia['nombre_evidencia']);?></span></h5>					
					<div class="row-fluid">
					...
					<div class="row-fluid">
						...
						<div class="span10"><i class="fa icon-caret-right"></i> <?php echo $evidencia['relacion']?></div>
					</div>
					<hr>
				</div>
				<?php endforeach;?>
