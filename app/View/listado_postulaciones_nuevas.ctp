		...
		<table class="table table-bordered table-hover">
			<thead>
				<tr>
					...
					<th style="width:105px;"><?php echo $this->Paginator->sort('fecha', 'Modificada');						
						if ($orden == 'fecha'){
							if ($this->params['named']['direction'] == 'asc') {
								echo ' <i class="icon-caret-down flechita"></i>';
							}
			...
			<tbody>
				...
				foreach($postulaciones as $k => $postulacion):?>
					...
					<tr>
						...
						<td><?php echo strtoupper($postulacion['Postulante']['apellidos']); ?></td>
