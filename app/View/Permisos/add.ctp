<div class="row-fluid vista">
	<div class="span10 offset1">
		...
		<h3>Agregar Perfil de Usuario:</h3>
		<div class="row-fluid">
			<div class="span7">
				...
				<?php echo $this->Form->create('Permisos', array(
					  ...
					  ?>
                                <p><strong>Establecer permisos:</strong><i><br><br><span class="label label-warning">Debe seleccionar al menos un elemento de menú</span></i><br><br></p>					
					<?php 
					$i=0;
