<?php
	...
	class EvaluadoresController extends AppController {
	
		var $name = 'Evaluadores';
...
/*													   										 				  
		...
		//ESTA FUNCIÓN ES IDÉNTICA A LA DE ADMINISTRATIVOS PERO SÓLO SE MUESTRAN LAS EVIDENCIAS FINALES
