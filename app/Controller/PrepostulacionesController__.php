...
class PrepostulacionesController extends AppController{
	...
	*/
	...
	private function subirArchivo($archivo){
                ...
                if(count($this->Session->read('UserLogued')) > 0){
                    $ruta = $this->webroot.'uploads/prepostulaciones'.$archivo['ArchivoPostulante']['codigo'].'.'.$archivo['ArchivoPostulante']['extension'];
        ...
        private function subirArchivoAnexo($anexo){
            ...
            if(count($this->Session->read('UserLogued')) > 0){
                $ruta = $this->webroot.'uploads/prepostulaciones/'.$anexo['ArchivoPrepostulacion']['codigo'].'.'.$anexo['ArchivoPrepostulacion']['extension'];
